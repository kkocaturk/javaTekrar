...
##  33. gün
- pollymorphism
-  bir method override edildiginde child class'da @Override notasyonu KULLANILABILIR

- kullanmak veya kullanmamak arasinda  pratikte soyle bir sonuc olusur. 

- eger notasyon kullanilirsa 
- iki method arasindaki iliski takip edilir parent class'daki method silinirse notasyon CTE verir

- notasyon yoksa
- parent class'daki overriden method silinirse bir uyari verilmez, CTE olusmaz


- Parent Class'ta Child ClassTaki aynı signature ile method varsa overriding yapılır super.method1() ile overridden method parentteki çalışır.
```
    @Override
    void method1() {
         super.method1();
...
- return type ve access modifier  signature'a dahil degildir ancak overriding'de bunlarla ilgili de kurallar vardir
