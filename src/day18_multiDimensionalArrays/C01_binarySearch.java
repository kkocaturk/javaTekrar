...
public class C01_binarySearch {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("--- // Array'de binarySearch()'nun duzgun calismasi icin\n" +
                            "   // oncelikle sort() calistirilmalidir");

        // Array'de binarySearch()'nun duzgun calismasi icin
        // oncelikle sort() calistirilmalidir

        System.out.println("\nArrays.sort(arr);  yapılmadan önce → " + Arrays.toString(arr));
        ...
        System.out.println("---         // binarySearch() aranan elementin index'ini doner\n");
